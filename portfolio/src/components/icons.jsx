// lucide-react removed brand/logo icons (trademark reasons), so GitHub and
// LinkedIn are hand-drawn here as simple stroke icons to match the rest of
// the icon set (currentColor, 24x24 viewBox, ~2px stroke).
